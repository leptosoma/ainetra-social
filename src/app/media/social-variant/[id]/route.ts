...
import { readSocialVariantOutput } from "@/features/social-variant/service";

// Karar verilmeden önce sosyal format sürümünü önizlemek için. Saklanan çıktı ayrıca bir MediaAsset
...
export async function GET(_request: Request, { params }: { params: Promise<{ id: string }> }) {
  ...
  const output = await readSocialVariantOutput(user.id, id);
