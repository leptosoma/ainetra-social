      ...
      <div className="settings-grid">
        ...
        <section className="panel"><div className="panel-title"><div><span className="eyebrow dark">Marka profili</span><h2>Kimlik ve ses</h2></div></div>
          <form action={updateBrandAction} className="stack-form compact">
            ...
            <div className="tone-grid"><label>Kurumsal ↔ Samimi <input type="range" name="corporateFriendly" min="0" max="100" defaultValue={tones.corporateFriendly ?? tones.friendly ?? 65} /></label><label>Minimal ↔ Canlı <input type="range" name="minimalVibrant" min="0" max="100" defaultValue={tones.minimalVibrant ?? 50} /></label><label>Lüks ↔ Erişilebilir <input type="range" name="luxuryAccessible" min="0" max="100" defaultValue={tones.luxuryAccessible ?? (100 - Number(tones.premium ?? 55))} /></label><label>Modern ↔ Doğal <input type="range" name="modernNatural" min="0" max="100" defaultValue={tones.modernNatural ?? 50} /></label><label>Ciddi ↔ Eğlenceli <input type="range" name="seriousPlayful" min="0" max="100" defaultValue={tones.seriousPlayful ?? tones.playful ?? 40} /></label></div>
