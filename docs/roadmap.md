...
- **P6-04 — Scheduled PostgreSQL Worker (READY; not implemented):** claim due intents with leases, bounded retry for definite safe failures, crash-safe processing and operational visibility using the P6-03 execution unit. No BullMQ. Packet: `claude-tasks/P6-04-postgres-scheduled-worker.md`.
