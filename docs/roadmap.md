...
- **P6-02 — Meta Account Connection (READY; not implemented):** secure native Instagram/Facebook OAuth, tenant/account mapping, encrypted token boundary, rotation/revocation and connection audit. No publication yet. Packet: `claude-tasks/P6-02-meta-account-connection.md`.
